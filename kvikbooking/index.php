  ...
  <div class="color">
    ...
    <div class=" text-center mb-5">
      <div class="container">
        ...
        <p class="lead">Rent an apartment at any time of the day</p>
      </div>
    </div>

    <div class="container ">
      <form class="p-4 w-50 mx-auto pt-4 bg-light rounded-lg shadow-sm" action="loginVerification.php" method="POST">
        ...
        <input name="submit" type="submit" value="Log in" style="background-color: #B9CFE3;" class="btn w-100 mt-4">
        <div id="_errorAlert" class="mt-4 d-flex flex-column"></div>
        <a href="register.php">
          <p class="p-color text-center">New here? Register an account!</p>
        </a>
